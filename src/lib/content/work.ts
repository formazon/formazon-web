...
export const workCases: Record<string, WorkCase> = {
    appfortype: {
        ...
        images: [
            ...
            {
                src: "/work/appfortype/appfortype-2.jpg",
                alt: "The 'Sheer' feature: scanning real handwriting into the app",
                width: 3840,
                height: 2370,
            },
            {
                src: "/work/appfortype/appfortype-3.jpg",
            ...
            {
                src: "/work/appfortype/appfortype-4.jpg",
    ...
    fuelet: {
        ...
        images: [
            ...
            {
                src: "/work/fuelet/fuelet-wallet-8.jpg",
                alt: "Fuelet money transfer flow with guided confirmations",
                width: 1920,
                height: 2370,
                groupWithNext: true,
            ...
            {
                src: "/work/fuelet/fuelet-wallet-9.jpg",
                alt: "Fuelet money transfer flow with guided confirmations",
                width: 1920,
                height: 2370,
